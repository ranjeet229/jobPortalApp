export const USER_API_END_POINT ="https://jobportalapp-backend.onrender.com/api/v1/user";
export const JOB_API_END_POINT ="https://jobportalapp-backend.onrender.com/api/v1/job";
